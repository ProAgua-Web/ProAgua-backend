# Generated by Django 5.1.5 on 2025-06-12 19:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('min_cor', models.FloatField(blank=True, default=None, null=True, verbose_name='cor mínima')),
                ('max_cor', models.FloatField(blank=True, default=None, null=True, verbose_name='cor máxima')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo', models.IntegerField(choices=[(0, 'Bebedouro'), (1, 'Torneira'), (2, 'Reservatório predial superior'), (3, 'Reservatório predial inferior'), (4, 'Reservatório de distribuição superior'), (5, 'Reservatório de distribuição inferior'), (6, 'CAERN')], default=(0, 'Bebedouro'), verbose_name='tipo')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ordem', models.SmallIntegerField(default=0, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(2)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo', models.CharField(choices=[('Limpeza de reservatório', 'Limpeza de reservatório'), ('Instalação de ponto de coleta', 'Instalação de ponto de coleta'), ('Conserto de reservatório', 'Conserto de reservatório'), ('Outro', 'Outro')], default='Limpeza de reservatório', max_length=50, verbose_name='tipo de solicitação')),
